...
- **Dependency Security Updates**:
  - Upgraded Next.js from 14.2.15 to 14.2.33 to address critical security vulnerabilities:
    - Fixed Authorization Bypass in Next.js Middleware (CVE-2024-XXXXX, CVSS 9.1)
    - Fixed Cache Key Confusion for Image Optimization API Routes (CVE-2024-XXXXX, CVSS 6.2)
    - Fixed Improper Middleware Redirect Handling Leading to SSRF (CVE-2024-XXXXX, CVSS 6.5)
    - Fixed Content Injection Vulnerability for Image Optimization (CVE-2024-XXXXX, CVSS 4.3)
    - Fixed Race Condition to Cache Poisoning (CVE-2024-XXXXX, CVSS 3.7)
    - Fixed Denial of Service (DoS) with Server Actions (CVE-2024-XXXXX, CVSS 5.3)
